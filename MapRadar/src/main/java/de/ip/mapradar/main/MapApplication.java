...
import static de.ip.mapradar.model.SortingMethod.ALPHABET;
import static de.ip.mapradar.model.SortingMethod.valueOf;
import static de.ip.mapradar.model.Transportation.FOOT;
import de.ip.mapradar.apputil.ObjectSerializer;
import org.json.*;
...
public class MapApplication extends Application {
    ...
    public Map<String, String> getMainCategories() {
    ...
    private Map<String, String> mainCategories;
...
//        return api;
    ...
    private void initializeApp() {
        ...
        mainCategories = new LinkedHashMap<>(22);
    ...
    public final class Preference {
        ...
        public Transportation getTransportation() {
            return Transportation.valueOf(mPref.getString("transport", FOOT.toString()));
        }
        ...
        private Set<String> allIndizes() {
            int numOfCategories = mainCategories.size();
    ...
    private void loadJSONCategories() {
        try {
            ...
            for (int i = 0; i < yelpCategoriesJSONArray.length(); i++) {
                ...
                mainCategories.put(title, alias);
