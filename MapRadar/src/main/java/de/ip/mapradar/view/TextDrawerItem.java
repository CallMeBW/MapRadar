...
public class TextDrawerItem extends DrawerItem<TextView> {
    protected final String txt;
    protected int iconDrawable;

    public TextDrawerItem(String text) {
        this.txt = text;
        this.iconDrawable = 0;
    }

    public TextDrawerItem(String text, int iconDrawable) {
        this.txt = text;
    ...
    public TextDrawerItem setIconDrawable(int iconDrawable) {
        this.iconDrawable = iconDrawable;
        return this;
    }
    ...
    public View drawView(View source, LayoutInflater inflater) {
        View ret = inflater.inflate(R.layout.plaintext_list_item, null);
