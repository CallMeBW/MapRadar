...
public class GooglePlaces {
    ...
    public InputStream getPlacePhotoStream(String photoReference,int maxW)
            throws JSONException, ClientProtocolException, IOException {
        PhotoQuery query = new PhotoQuery(photoReference,maxW);
        return getResponseBody(query.toString());
    }

    private InputStream getResponseBody(String query) throws IOException {
        query += "key=" + mApiKey;
